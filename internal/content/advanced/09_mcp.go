	...
	lesson.Register(types.LessonDef{
		...
		Questions: []types.QuizQuestion{
			...
			},
			{
				...
				CorrectIdx: 2,
				Explanation: "MCP uses stdio for local servers (process communication) and SSE for remote servers.",
			},
		},
	})
}
