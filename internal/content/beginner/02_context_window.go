...
func init() {
	lesson.Register(types.LessonDef{
		...
		Theory: []types.TheoryBlock{
			...
			{Kind: types.Paragraph, Content: "Claude's context window is 200,000 tokens — roughly 150,000 words or 30,000 lines of code. While this is enormous, it's not infinite. Large codebases, long conversations, and verbose tool outputs can fill it up."},
